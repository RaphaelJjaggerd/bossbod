...
public class FragmentVideoBindingImpl extends FragmentVideoBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.handler == variableId) {
            setHandler((com.bossbod.fragments.VideoFragment.ClickHandler) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setHandler(@Nullable com.bossbod.fragments.VideoFragment.ClickHandler Handler) {
