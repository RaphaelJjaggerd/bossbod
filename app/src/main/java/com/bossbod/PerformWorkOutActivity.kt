...
import com.bossbod.databinding.ActivityPerformExerciesBinding
import com.bossbod.databinding.DialogQuiteWorkoutBinding
import com.bossbod.dialog.ExerciseDetailDialogFragment
import com.bossbod.interfaces.AdsCallback
import com.bossbod.interfaces.DialogDismissListener
import com.bossbod.objects.HomeExTableClass
import com.bossbod.objects.HomePlanTableClass
import com.bossbod.utils.*
...
class PerformWorkOutActivity : BaseActivity() {
    ...
    private fun initReadyToGo() {
        ...
        if (Utils.getPref(this, Constant.PREF_IS_INSTRUCTION_SOUND_ON, true))
            bossbod.speechText(this, readyToGoText)
    }
                ...
                if (readyToGoTime - timeCountDown >= 0) {
                    ...
                    if (timeCountDown == readyToGoTime.toInt() / 2) {
                        ...
                        if (Utils.getPref(
                            ...
                            bossbod.speechText(this@PerformWorkOutActivity, readyToGoText)
...
//        binding!!.progressBarReadyToGo.progressMax = currentExe!!.exTime!!.toFloat()-1
                    ...
                    if ((exerciseTime - timeCountDown) >= 0) {
                        ...
                        if (Utils.getPref(
                            ...
                            if (timeCountDown == halfTime) {
                                bossbod.speechText(this@PerformWorkOutActivity, "Half time")
    ...
    private fun onWorkoutTimeOver() {
        ...
        if (currentPos == exercisesList!!.lastIndex) {
            ...
            if (Utils.getPref(this, Constant.PREF_IS_INSTRUCTION_SOUND_ON, true))
                bossbod.speechText(this, "Congratulation")
            goToCompleteScreen()
        } else {
            goToRestScreen()
        }
    ...
    /*private fun playMusic() {
        if (currMusic != null) {
            if (bossbod.musicUtil == null || bossbod.musicUtil!!.isPlaying.not()) {
                ...
                bossbod.playMusic(currMusic!!, this@PerformWorkOutActivity)
    ...
    fun showQuitDialog() {
        if (Utils.getPref(this, Constant.PREF_IS_INSTRUCTION_SOUND_ON, true))
            bossbod.speechText(this, getString(R.string.quite_exercise_msg))
