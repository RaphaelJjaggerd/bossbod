...
public class ActivityEditPlanBindingImpl extends ActivityEditPlanBinding implements com.bossbod.generated.callback.OnClickListener.Listener {
    ...
    private ActivityEditPlanBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback5 = new com.bossbod.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.handler == variableId) {
            setHandler((com.bossbod.EditPlanActivity.ClickHandler) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setHandler(@Nullable com.bossbod.EditPlanActivity.ClickHandler Handler) {
    ...
    protected void executeBindings() {
        ...
        com.bossbod.EditPlanActivity.ClickHandler handler = mHandler;
        // batch finished
