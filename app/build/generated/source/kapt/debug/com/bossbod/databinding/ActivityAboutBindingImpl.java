...
public class ActivityAboutBindingImpl extends ActivityAboutBinding implements com.bossbod.generated.callback.OnClickListener.Listener {
    ...
    private ActivityAboutBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback62 = new com.bossbod.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.handler == variableId) {
            setHandler((com.bossbod.AboutActivity.ClickHandler) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setHandler(@Nullable com.bossbod.AboutActivity.ClickHandler Handler) {
    ...
    protected void executeBindings() {
        ...
        com.bossbod.AboutActivity.ClickHandler handler = mHandler;
        // batch finished
