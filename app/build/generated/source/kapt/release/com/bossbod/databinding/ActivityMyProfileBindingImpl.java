...
public class ActivityMyProfileBindingImpl extends ActivityMyProfileBinding implements com.bossbod.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sIncludes.setIncludes(1, 
            new String[] {"topbar"},
            new int[] {7},
            new int[] {com.bossbod.R.layout.topbar});
    ...
    private ActivityMyProfileBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (com.bossbod.databinding.TopbarBinding) bindings[7]
        ...
        setRootTag(root);
        // listeners
        mCallback69 = new com.bossbod.generated.callback.OnClickListener(this, 2);
        mCallback68 = new com.bossbod.generated.callback.OnClickListener(this, 1);
        mCallback72 = new com.bossbod.generated.callback.OnClickListener(this, 5);
        mCallback70 = new com.bossbod.generated.callback.OnClickListener(this, 3);
        mCallback71 = new com.bossbod.generated.callback.OnClickListener(this, 4);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.handler == variableId) {
            setHandler((com.bossbod.MyProfileActivity.ClickHandler) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setHandler(@Nullable com.bossbod.MyProfileActivity.ClickHandler Handler) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeTopbar((com.bossbod.databinding.TopbarBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeTopbar(com.bossbod.databinding.TopbarBinding Topbar, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        com.bossbod.MyProfileActivity.ClickHandler handler = mHandler;
        // batch finished
