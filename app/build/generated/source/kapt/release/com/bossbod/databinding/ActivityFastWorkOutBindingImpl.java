...
public class ActivityFastWorkOutBindingImpl extends ActivityFastWorkOutBinding implements com.bossbod.generated.callback.OnClickListener.Listener {
    ...
    private ActivityFastWorkOutBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback74 = new com.bossbod.generated.callback.OnClickListener(this, 2);
        mCallback73 = new com.bossbod.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.handler == variableId) {
            setHandler((com.bossbod.FastWorkoutActivity.ClickHandler) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setHandler(@Nullable com.bossbod.FastWorkoutActivity.ClickHandler Handler) {
    ...
    protected void executeBindings() {
        ...
        com.bossbod.FastWorkoutActivity.ClickHandler handler = mHandler;
        // batch finished
