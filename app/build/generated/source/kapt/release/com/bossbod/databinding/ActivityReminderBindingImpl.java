...
public class ActivityReminderBindingImpl extends ActivityReminderBinding implements com.bossbod.generated.callback.OnClickListener.Listener {
    ...
    private ActivityReminderBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback87 = new com.bossbod.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.handler == variableId) {
            setHandler((com.bossbod.ReminderActivity.ClickHandler) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setHandler(@Nullable com.bossbod.ReminderActivity.ClickHandler Handler) {
    ...
    protected void executeBindings() {
        ...
        com.bossbod.ReminderActivity.ClickHandler handler = mHandler;
        // batch finished
