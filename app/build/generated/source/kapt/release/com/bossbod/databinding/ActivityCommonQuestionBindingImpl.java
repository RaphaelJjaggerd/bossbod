...
public class ActivityCommonQuestionBindingImpl extends ActivityCommonQuestionBinding implements com.bossbod.generated.callback.OnClickListener.Listener {
    ...
    private ActivityCommonQuestionBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (com.bossbod.databinding.TopbarBinding) bindings[3]
            );
        ...
        setRootTag(root);
        // listeners
        mCallback32 = new com.bossbod.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.handler == variableId) {
            setHandler((com.bossbod.CommonQuestionActivity.ClickHandler) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setHandler(@Nullable com.bossbod.CommonQuestionActivity.ClickHandler Handler) {
    ...
    protected void executeBindings() {
        ...
        com.bossbod.CommonQuestionActivity.ClickHandler handler = mHandler;
        // batch finished
