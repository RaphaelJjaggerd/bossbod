...
public class ActivityHomeBindingImpl extends ActivityHomeBinding implements com.bossbod.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sIncludes.setIncludes(2, 
            ...
            new int[] {3},
            new int[] {com.bossbod.R.layout.bottom_bar});
    ...
    private ActivityHomeBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            ...
            , (com.bossbod.databinding.BottomBarBinding) bindings[3]
        ...
        setRootTag(root);
        // listeners
        mCallback86 = new com.bossbod.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.handler == variableId) {
            setHandler((com.bossbod.HomeActivity.ClickHandler) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setHandler(@Nullable com.bossbod.HomeActivity.ClickHandler Handler) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeBottombar((com.bossbod.databinding.BottomBarBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeBottombar(com.bossbod.databinding.BottomBarBinding Bottombar, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        com.bossbod.HomeActivity.ClickHandler handler = mHandler;
        // batch finished
