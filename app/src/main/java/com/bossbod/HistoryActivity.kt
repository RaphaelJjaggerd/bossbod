...
import com.bossbod.adapter.HistoryExpandableAdapter
import com.bossbod.databinding.ActivityHistoryBinding
...
class HistoryActivity : BaseActivity() {
    ...
    private fun initIntentParam() {
        try {
            com.bossbod.utils.Debug.e("","history activity:::::===>>  $intent")
        } catch (e: Exception) {
            e.printStackTrace()
        }
    }
