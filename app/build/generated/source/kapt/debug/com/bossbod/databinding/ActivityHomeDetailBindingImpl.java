...
public class ActivityHomeDetailBindingImpl extends ActivityHomeDetailBinding implements com.bossbod.generated.callback.OnClickListener.Listener {
    ...
    private ActivityHomeDetailBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback108 = new com.bossbod.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.handler == variableId) {
            setHandler((com.bossbod.HomeDetailActivity.ClickHandler) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setHandler(@Nullable com.bossbod.HomeDetailActivity.ClickHandler Handler) {
    ...
    protected void executeBindings() {
        ...
        com.bossbod.HomeDetailActivity.ClickHandler handler = mHandler;
        // batch finished
